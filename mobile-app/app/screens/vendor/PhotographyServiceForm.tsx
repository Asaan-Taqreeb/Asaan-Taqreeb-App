...
export default function PhotographyServiceForm() {
    ...
    <View style={[styles.container, {paddingTop: insets.top, paddingBottom: insets.bottom}]}>
      ...
      <View className='flex-row items-center gap-4 px-5 py-4' style={{borderBottomWidth: 1, borderBottomColor: Colors.border}}>
        <Pressable 
          ...
          onPress={() => router.back()}
        >
          <ArrowLeft color={Colors.photo} size={24} />
        </Pressable>
        <View className='flex-row items-center gap-3 flex-1'>
          <View className='rounded-full p-2' style={{backgroundColor: `${Colors.photo}20`}}>
            <Camera size={24} color={Colors.photo} />
          </View>
          <View>
            <Text className='text-xl font-extrabold' style={{color: Colors.textPrimary}}>Photography Service</Text>
            <Text className='text-xs font-medium' style={{color: Colors.textSecondary}}>Setup your packages & portfolio</Text>
          </View>
        </View>
      </View>
      ...
      <ScrollView className='flex-1 px-5 py-6' showsVerticalScrollIndicator={false}>
        ...
        <View className='rounded-2xl p-5 mb-4' style={[{backgroundColor: Colors.white}, Shadows.medium]}>
          ...
          <Text className='text-sm font-semibold mb-2' style={{color: Colors.textSecondary}}>Studio/Business Name *</Text>
          <TextInput
          ...
          <TextInput
            style={[styles.input, {borderColor: Colors.border, color: Colors.textPrimary}]}
            placeholder="e.g., Near Sunset Boulevard"
            placeholderTextColor={Colors.textTertiary}
          ...
          <TextInput
            ...
            placeholder="Describe your photography style, experience, equipment, and what makes your service unique..."
            placeholderTextColor={Colors.textTertiary}
            value={about}
        ...
        <View className='rounded-2xl p-5 mb-4' style={[{backgroundColor: Colors.white}, Shadows.medium]}>
          <View className='flex-row justify-between items-center mb-4'>
            <Text className='text-lg font-extrabold' style={{color: Colors.textPrimary}}>Photography Packages</Text>
            <Pressable 
          ...
          {packages.map((pkg, pkgIndex) => (
            <View key={pkg.id} className='mb-4 p-4 rounded-xl' style={{backgroundColor: Colors.background, borderWidth: 1, borderColor: Colors.border}}>
              ...
              <View className='flex-row justify-between items-center mt-3 mb-2'>
                <Text className='text-sm font-semibold' style={{color: Colors.textSecondary}}>Package Details *</Text>
                <Pressable 
              ...
              {pkg.items.map((item, itemIndex) => (
                <View key={itemIndex} className='flex-row gap-2 mb-2'>
                  <TextInput
                    ...
                    placeholder="e.g., 8 Hours Coverage, 2 Photographers, 1500+ Photos"
                    placeholderTextColor={Colors.textTertiary}
                    value={item}
        ...
        <View className='rounded-2xl p-5 mb-4' style={[{backgroundColor: Colors.white}, Shadows.medium]}>
          ...
          <Text className='text-xs font-medium mb-4' style={{color: Colors.textSecondary}}>Define your daily work hours range (e.g. 09:00 AM to 09:00 PM)</Text>
        ...
        <View className='rounded-2xl p-5 mb-4' style={[{backgroundColor: Colors.white}, Shadows.medium]}>
          <View className='flex-row justify-between items-center mb-4'>
            <View>
              ...
              <Text className='text-xs font-medium mt-1' style={{color: Colors.textSecondary}}>Add extra services like prints, albums, etc.</Text>
            </View>
            <Pressable 
              className='flex-row items-center gap-2 px-4 py-2 rounded-lg active:opacity-70'
              style={{backgroundColor: Colors.photo}}
          ...
          {optionalServices.map((service, index) => (
            <View key={service.id} className='mb-3 p-3 rounded-xl' style={{backgroundColor: Colors.background, borderWidth: 1, borderColor: Colors.border}}>
              ...
              <TextInput
                ...
                placeholder="e.g., Extra Prints, Photo Album, Cinematic Video"
                placeholderTextColor={Colors.textTertiary}
                value={service.name}
        ...
        <Pressable 
          ...
          style={{backgroundColor: Colors.photo, marginBottom: 40, opacity: isSubmitting ? 0.7 : 1}}
